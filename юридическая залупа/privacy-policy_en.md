...
## Appendix — Form microcopy (EN i18n strings)

Drop-in replacements for the current one-liner. These are specific and informed (consent-route), and they flag the cross-border transfer for the contact form.

### Contact form

```json
"contact": {
  "privacy": "By submitting, I consent to my contact details and message being processed — including transfer to providers outside the EEA — so my enquiry can be answered. See the privacy policy."
}
```
...
"post": {
  "comments": {
    "privacy": "By submitting, I consent to my handle and comment being stored and published. See the privacy policy."
  }
}
```

**Implementation notes:**
- "privacy policy" is a link to this document. No separate consent page is needed for the EN/GDPR audience.
- If you prefer the lighter *notice* route (relying on legitimate interest / pre-contractual steps rather than consent) for the contact form, you may keep wording closer to a statement of fact — but still say *what* happens, e.g. "Your message is sent to me by email to answer your enquiry. See the privacy policy." Avoid the bare "you agree to the privacy policy" — it's too vague to count as informed consent.
- Keep the consent action unbundled: don't merge it with newsletter sign-ups or other terms in one checkbox.
