    ...
    <div class="footer-inner">
      <div class="footer-left">
        <picture>
          ...
          <img src="/avatar-128.png" alt="" class="footer-avatar" aria-hidden="true" width="128" height="128" />
        </picture>
...
.footer-inner {
  ...
  gap: 1rem;
  flex-wrap: wrap;
  padding: 1.625rem clamp(1.25rem, 0.1538rem + 4.8718vw, 6rem);
}
